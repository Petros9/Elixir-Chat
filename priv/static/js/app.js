...
if (roomId) {
  ...
  channel.join().receive("ok", function (resp) {
    ...
    resp.messages.reverse().map(function (mess) {
      return displayMessage(mess);
    });
  ...
  var displayMessage = function displayMessage(message) {
    var template = "\n    <li class=\"list-group-item\"><strong>".concat(message.user.username, "</strong>: ").concat(message.body, "</li>\n    ");
